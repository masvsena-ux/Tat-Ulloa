...
<head>
    ...
    <title>Ulloa Tatú - Usuarios Inactivos</title>
...
<div class="main">
    <h2 class="st">Usuarios Inactivos</h2>
    ...
    <div class="action-container">
        <button onclick="window.location.href='{{ route('usuarios') }}'" class="btn-submit">
            Volver a Usuarios
        </button>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('usuarios.reactivar', $u->Id) }}" method="POST" style="display:inline">
                            @csrf
                            <button type="submit" class="btn-submit">Reactivar</button>
                        </form>
                    </td>
                </tr>
                @endforeach
